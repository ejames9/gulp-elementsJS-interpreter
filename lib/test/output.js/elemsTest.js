...
1 /*--------------------------------------------------------*/ 1
$("main") ? dom("main") :  make(".main1", "main").put("body");
...
,make('.list-item', "li").put('#list')
          ...
          .borderRadius('25px');
2 /*--------------------------------------------------------*/ 2
 $('#footer') ? dom('#footer') :  make('#footer').put("body");
 make('#tap').put("body");
 make('#slip').put("body");
...
,make('.switch', "button").put('#hillside')
           ...
           .on('click', fuckOff);
3 /*--------------------------------------------------------*/ 3
 $('#header') ? dom('#header') :  make('#header').put("body");
 [
...
,make(".button1", "button").put('#header')
           ...
           .on('docready', fuckOnn);
4 /*--------------------------------------------------------*/ 4
$("body") ? dom("body") :  make(".body1", "body").put("body");
 [
...
,make('.buttons').put('#footer')
                      ...
                      .on('click', fuckOff);
6 /*--------------------------------------------------------*/ 6
var elem0 = $('#header') ? dom('#header') :  make('#header').put("body"); 
	 elem0
          .on('docready', fuckOnn);
7 /*--------------------------------------------------------*/ 7
$('#input') ? dom('#input') :  make('#input', "input").put("body");
