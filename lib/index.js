  ...
  this._transform = (file, encoding, fin)=> {
    ...
    if (file._isVinyl) {
      ...
      if (file.isBuffer()) {
        ...
        this.file = ElementsInterpreter(this.file);        log(file.contents, ['green', 'bold']);
    ...
    //Check file.contents in console.
    // setTimeout(()=> {
    //   rawBody(file.contents, 'utf8', (req, res)=> {
    //     log(res.toString('utf8'), ['red', 'bold']);
    //   });
    // }, 2000);
